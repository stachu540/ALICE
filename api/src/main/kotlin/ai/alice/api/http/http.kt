...
interface IBody {
    ...
    fun <T : Any> to(type: KClass<T>): T = to(type.java)
    val size: Long
        get() = toBytes().size.toLong()
}
...
enum class Status(
    ...
    /**
     * `103 Checkpoint`.
     * @see [A proposal for supporting resumable POST/PUT HTTP requests in HTTP/1.0](https://code.google.com/p/gears/wiki/ResumableHttpRequestsProposal)
     */
     ...
     */
    @Deprecated("in favor of [FOUND] which will be returned from `@code Status.of(302)`")
    ...
    /**
     * `410 Gone`.
     * @see [HTTP/1.1: Semantics and Content, section 6.5.9](https://tools.ietf.org/html/rfc7231#section-6.5.9)
     */
    GONE(410, "Gone"),
    /**
     * `411 Length Required`.
     * @see [HTTP/1.1: Semantics and Content, section 6.5.10](https://tools.ietf.org/html/rfc7231#section-6.5.10)
     */
    LENGTH_REQUIRED(411, "Length Required"),
    /**
     * `412 Precondition failed`.
     * @see [HTTP/1.1: Conditional Requests, section 4.2](https://tools.ietf.org/html/rfc7232#section-4.2)
     */
    PRECONDITION_FAILED(412, "Precondition Failed"),
    /**
     * `413 Payload Too Large`.
     * @see [HTTP/1.1: Semantics and Content, section 6.5.11](https://tools.ietf.org/html/rfc7231#section-6.5.11)
     */
     ...
     */
    @Deprecated("in favor of [PAYLOAD_TOO_LARGE] which will be returned from `@code Status.of(413)`")
    REQUEST_ENTITY_TOO_LARGE(413, "Request Entity Too Large"),
    /**
     * `414 URI Too Long`.
     * @since 4.1
     * @see [HTTP/1.1: Semantics and Content, section 6.5.12](https://tools.ietf.org/html/rfc7231#section-6.5.12)
     */
     ...
     * @deprecated
     */
    @Deprecated("in favor of [URI_TOO_LONG] which will be returned from `Status.of(414)`")
    REQUEST_URI_TOO_LONG(414, "Request-URI Too Long"),
    /**
     * `415 Unsupported Media Type`.
     * @see [HTTP/1.1: Semantics and Content, section 6.5.13](https://tools.ietf.org/html/rfc7231#section-6.5.13)
     */
     ...
     * @see [HTTP/1.1: Semantics and Content, section 6.5.14](https://tools.ietf.org/html/rfc7231#section-6.5.14)
     */
    ...
    @Deprecated("See [WebDAV Draft Changes](https://tools.ietf.org/rfcdiff?difftype=--hwdiff&url2=draft-ietf-webdav-protocol-06.txt)")
     ...
     * @see [An HTTP Status Code to Report Legal Obstacles](https://tools.ietf.org/html/draft-ietf-httpbis-legally-restricted-status-04)
     */
...
inline fun <reified T : Any> IBody.to(): T = to(T::class)